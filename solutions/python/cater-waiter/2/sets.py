...
def check_drinks(drink_name, drink_ingredients):
    ...
    """
    begin_drink = ["M", "C"]
    return f"{drink_name} {begin_drink[bool(set(drink_ingredients) & ALCOHOLS)]}ocktail"
...
def categorize_dish(dish_name, dish_ingredients):
    ...
    for cat_set, cat_name in zip(categories, ["VEGAN", "VEGETARIAN", "KETO", "PALEO", "OMNIVORE"]):
        if ingredients.issubset(cat_set):
